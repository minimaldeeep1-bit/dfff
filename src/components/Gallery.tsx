      ...
      {lightboxOpen && (
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-full p-4 flex justify-between items-center text-white z-10">
            ...
            <button
              onClick={closeLightbox}
              className="p-2 bg-black/50 rounded-full hover:bg-white/20 transition-colors focus:outline-none focus-visible:ring-4 focus-visible:ring-safetyOrange"
              aria-label="Close"
            >
              <X className="w-6 h-6" />
            </button>
          ...
          <button
            onClick={showPrev}
            className="absolute left-4 p-3 bg-black/50 text-white rounded-full hover:bg-white/20 transition-colors z-10 hidden sm:block focus:outline-none focus-visible:ring-4 focus-visible:ring-safetyOrange"
          ...
          <button
            onClick={showNext}
            className="absolute right-4 p-3 bg-black/50 text-white rounded-full hover:bg-white/20 transition-colors z-10 hidden sm:block focus:outline-none focus-visible:ring-4 focus-visible:ring-safetyOrange"
