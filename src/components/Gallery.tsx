        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {galleryImages.map((img, index) => (
            <div
              ...
              className="relative group overflow-hidden rounded-xl cursor-pointer aspect-[4/3] bg-gray-200 focus:outline-none focus-visible:ring-4 focus-visible:ring-safetyOrange focus-visible:ring-offset-2"
            >
