...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-slateGray text-crispWhite z-50 shadow-md">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex md:hidden items-center">
            <button
              ...
              className="text-crispWhite hover:text-safetyOrange focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-safetyOrange focus-visible:ring-inset"
      ...
      {/* Mobile Menu Overlay */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-slateGray border-t border-gray-700">
