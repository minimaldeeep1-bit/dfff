          ...
          {pricingData.map((item, index) => (
            <div key={index} className="bg-white rounded-lg border border-slate-200 overflow-hidden shadow-sm">
              <button
                ...
                className="w-full flex justify-between items-center p-4 focus:outline-none focus-visible:ring-2 focus-visible:ring-safetyOrange focus-visible:ring-inset focus-visible:outline-none"
              ...
              {openIndex === index && (
                <div
                  ...
                  role="region"
                  aria-labelledby={`pricing-button-${index}`}
